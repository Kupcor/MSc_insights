...
class PredictionModel(nn.Module):
    def __init__(self, hidden_layers_neurons, hidden_layers_activation_function="ReLU", input_size = 10, is_batch_normalization_implemented = True, is_dropout = True, dropout_num = 0.2):
        super().__init__()
